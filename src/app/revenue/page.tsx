...
export default function RevenuePage() {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    const revenueCollectionRef = collection(db, "revenueRecords"); // Updated collection name
    const q = query(
    ...
    <AuthGuard>
      <AuthenticatedLayout>
        <PageHeader
          ...
          description="Manage revenue records from various sources (non-invoice)."
          actions={
                    ...
                    filteredRecords.map((record) => (
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  This action cannot be undone. This will permanently delete this revenue record from "{record.source}".
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                      ...
                      <TableRow>
                        <TableCell colSpan={6} className="text-center py-10 text-muted-foreground">
                          {revenueRecords.length === 0 ? "No revenue recorded yet." : "No records match your search."}
                        </TableCell>
                      </TableRow>
                  )}
                </TableBody>
